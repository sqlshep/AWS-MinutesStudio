...
namespace MinutesStudio.Core.Prompts;

/// <summary>
/// The Minutes Studio prompt library. Four production-ready, grounded prompt templates
...
public static class PromptLibrary
{
    ...
    public static string DocumentChatSystemPrompt =>
        ...
        meeting minutes for a Minutes Studio staff member. Answer conversationally but precisely.
